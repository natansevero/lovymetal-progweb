...
<html lang="en">
    ...
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
		...
		<title>P�gina Inicial | Lovy Metal</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-menu">
              ...
              <!-- Bot�o de configura��es -> Edita Conta e Excluir Conta -->
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Configura��es <span><img src="images/down-arrow.png" alt="" /></span></a>
        ...
        <div class="row">
          ...
          <div class="col-md-3 static">
            ...
            <ul class="nav-news-feed">
              <li><i class="icon ion-ios-paper"></i><div><a href="controller?command=ListarSolicitacao">Solicita��es</a></div></li>
